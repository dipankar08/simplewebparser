...
exports.urlList = [
    ...
    },
    {
        ...
        links: [
            ...
            { url: 'https://www.bongnews24x7.com/category/sports/', 'stream': CONST_1.STREAM.SPORTS },
            { url: 'https://www.bongnews24x7.com/category/employment-news/', 'stream': CONST_1.STREAM.JOB },
            { url: 'https://www.bongnews24x7.com/category/unknown-facts/', 'stream': CONST_1.STREAM.OFF_BEAT },
            { url: 'https://www.bongnews24x7.com/category/fashion-and-beauty/', 'stream': CONST_1.STREAM.LIFESTYLE },
            { url: 'https://www.bongnews24x7.com/category/entertainment/', 'stream': CONST_1.STREAM.ENTERTAINMENT },
            { url: 'https://www.bongnews24x7.com/category/good-luck/', 'stream': CONST_1.STREAM.HOROSCOPE },
        ],
        limit: 5,
        is_rss_feed: false,
    ...
    },
    {
        ...
        is_partner: true,
        links: [
            { url: 'https://www.thewall.in/feed', 'stream': CONST_1.STREAM.FIRST_PAGE },
        ],
        is_rss_feed: true,
        rsstype: new rss_reader_1.WordPressRssReader(),
    },
    {
        ...
        links: [
            ...
            { url: 'https://www.master24.in/archives/category/editorial/feed', 'stream': CONST_1.STREAM.EDITORIAL },
            { url: 'https://www.master24.in/archives/category/tech-news/feed', 'stream': CONST_1.STREAM.TECHNOLOGY },
            { url: 'https://www.master24.in/archives/category/job-and-business/feed', 'stream': CONST_1.STREAM.JOB },
            { url: 'https://www.master24.in/archives/category/sports/feed', 'stream': CONST_1.STREAM.SPORTS },
            { url: 'https://www.master24.in/feed', 'stream': CONST_1.STREAM.LATEST },
        ],
        is_rss_feed: true,
        rsstype: new rss_reader_1.WordPressRssReader(),
    },
    {
        ...
        is_partner: true,
        links: [
            { url: 'http://www.natungati.com/feed/', 'stream': CONST_1.STREAM.LATEST },
        ],
        is_rss_feed: true,
        rsstype: new rss_reader_1.WordPressRssReader(),
    },
