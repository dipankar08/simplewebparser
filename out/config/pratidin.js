...
var PratidinConfig = /** @class */ (function (_super) {
    ...
    PratidinConfig.prototype.getStoryListConfig = function () {
        return [
            { stream: CONST_1.STREAM.FIRST_PAGE, selector: '.carousel  .scale_img_block > a', url: 'https://www.sangbadpratidin.in/', limit: 15 },
            { stream: CONST_1.STREAM.FIRST_PAGE, selector: '.daily-news  .scale_img_block > a', url: 'https://www.sangbadpratidin.in/', limit: 10 },
