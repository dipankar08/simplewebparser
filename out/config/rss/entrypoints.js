/*
    ...
    {url:'https://www.darkaritips.com/category/health-message/', extra:{'stream':STREAM.HEALTH, 'lang':LANG.IN_BENGALI,'categories':CATEGORIES.NEWS}, type:RSS_TYPE.WORD_PRESS},
    {url:'https://www.darkaritips.com/category/lifestyle/', extra:{'stream':STREAM.LIFESTYLE, 'lang':LANG.IN_BENGALI,'categories':CATEGORIES.NEWS}, type:RSS_TYPE.WORD_PRESS},
    {url:'https://www.darkaritips.com/category/recipe/', extra:{'stream':STREAM.RECIPE, 'lang':LANG.IN_BENGALI,'categories':CATEGORIES.NEWS}, type:RSS_TYPE.WORD_PRESS},
    {url:'https://www.darkaritips.com/category/tech-tips/', extra:{'stream':STREAM.TECHNOLOGY, 'lang':LANG.IN_BENGALI,'categories':CATEGORIES.NEWS}, type:RSS_TYPE.WORD_PRESS},
    {url:'https://www.darkaritips.com/category/viral-news/', extra:{'stream':STREAM.VIRAL, 'lang':LANG.IN_BENGALI,'categories':CATEGORIES.NEWS}, type:RSS_TYPE.WORD_PRESS},
    {url:'https://www.darkaritips.com/category/health-nutrition/', extra:{'stream':STREAM.HEALTH, 'lang':LANG.IN_BENGALI,'categories':CATEGORIES.NEWS}, type:RSS_TYPE.WORD_PRESS},
    {url:'https://www.darkaritips.com/category/health-beauty/', extra:{'stream':STREAM.HEALTH, 'lang':LANG.IN_BENGALI,'categories':CATEGORIES.NEWS}, type:RSS_TYPE.WORD_PRESS},
    {url:'https://www.darkaritips.com/category/luck/', extra:{'stream':STREAM.LIFESTYLE, 'lang':LANG.IN_BENGALI,'categories':CATEGORIES.NEWS}, type:RSS_TYPE.WORD_PRESS},
    {url:'https://www.darkaritips.com/feed', extra:{'stream':STREAM.LIFESTYLE, 'lang':LANG.IN_BENGALI,'categories':CATEGORIES.NEWS}, type:RSS_TYPE.WORD_PRESS},
   
    // totka24x7
    {url:'https://www.totka24x7.com/archives/category/lifestyle/feed', extra:{'stream':STREAM.LIFESTYLE, 'lang':LANG.IN_BENGALI,'categories':CATEGORIES.NEWS}, type:RSS_TYPE.WORD_PRESS},
    {url:'https://www.totka24x7.com/archives/category/earn-money/feed', extra:{'stream':STREAM.BUSINESS, 'lang':LANG.IN_BENGALI,'categories':CATEGORIES.NEWS}, type:RSS_TYPE.WORD_PRESS},
    {url:'https://www.totka24x7.com/archives/category/viral/feed', extra:{'stream':STREAM.VIRAL, 'lang':LANG.IN_BENGALI,'categories':CATEGORIES.NEWS}, type:RSS_TYPE.WORD_PRESS},
    {url:'https://www.totka24x7.com/archives/category/entertainment/feed', extra:{'stream':STREAM.ENTERTAINMENT, 'lang':LANG.IN_BENGALI,'categories':CATEGORIES.NEWS}, type:RSS_TYPE.WORD_PRESS},
    {url:'https://www.totka24x7.com/archives/category/technology/feed', extra:{'stream':STREAM.TECHNOLOGY, 'lang':LANG.IN_BENGALI,'categories':CATEGORIES.NEWS}, type:RSS_TYPE.WORD_PRESS},
    {url:'https://www.totka24x7.com/archives/category/headlines/feed', extra:{'stream':STREAM.FIRST_PAGE, 'lang':LANG.IN_BENGALI,'categories':CATEGORIES.NEWS}, type:RSS_TYPE.WORD_PRESS},
    {url:'https://www.totka24x7.com/archives/category/astrology/feed', extra:{'stream':STREAM.ASTROLOGY, 'lang':LANG.IN_BENGALI,'categories':CATEGORIES.NEWS}, type:RSS_TYPE.WORD_PRESS},
    {url:'https://www.totka24x7.com/archives/category/different-news/feed', extra:{'stream':STREAM.OTHER, 'lang':LANG.IN_BENGALI,'categories':CATEGORIES.NEWS}, type:RSS_TYPE.WORD_PRESS},
    {url:'https://www.totka24x7.com/feed', extra:{'stream':STREAM.OTHER, 'lang':LANG.IN_BENGALI,'categories':CATEGORIES.NEWS}, type:RSS_TYPE.WORD_PRESS},
    ...
    {url:'https://www.nilkantho.in/category/news/sports/feed', extra:{'stream':STREAM.SPORTS, 'lang':LANG.IN_BENGALI,'categories':CATEGORIES.NEWS}, type:RSS_TYPE.WORD_PRESS},
    {url:'https://www.nilkantho.in/category/news/business/feed', extra:{'stream':STREAM.BUSINESS, 'lang':LANG.IN_BENGALI,'categories':CATEGORIES.NEWS}, type:RSS_TYPE.WORD_PRESS},
    {url:'https://www.nilkantho.in/category/news/scitech/feed', extra:{'stream':STREAM.TECHNOLOGY, 'lang':LANG.IN_BENGALI,'categories':CATEGORIES.NEWS}, type:RSS_TYPE.WORD_PRESS},
    {url:'https://www.nilkantho.in/category/health/feed', extra:{'stream':STREAM.HEALTH, 'lang':LANG.IN_BENGALI,'categories':CATEGORIES.NEWS}, type:RSS_TYPE.WORD_PRESS},
    {url:'https://www.nilkantho.in/category/lifestyle/feed', extra:{'stream':STREAM.LIFESTYLE, 'lang':LANG.IN_BENGALI,'categories':CATEGORIES.NEWS}, type:RSS_TYPE.WORD_PRESS},
    {url:'https://www.nilkantho.in/category/mythology/feed', extra:{'stream':STREAM.MYTHOLOGY, 'lang':LANG.IN_BENGALI,'categories':CATEGORIES.NEWS}, type:RSS_TYPE.WORD_PRESS},
    {url:'https://www.nilkantho.in/category/feature/feed', extra:{'stream':STREAM.OTHER, 'lang':LANG.IN_BENGALI,'categories':CATEGORIES.NEWS}, type:RSS_TYPE.WORD_PRESS},
    {url:'https://www.nilkantho.in/category/lets-go/feed', extra:{'stream':STREAM.TOUR, 'lang':LANG.IN_BENGALI,'categories':CATEGORIES.NEWS}, type:RSS_TYPE.WORD_PRESS},
    {url:'https://www.nilkantho.in/category/festive-mood/feed', extra:{'stream':STREAM.FESTIVE, 'lang':LANG.IN_BENGALI,'categories':CATEGORIES.NEWS}, type:RSS_TYPE.WORD_PRESS},
    {url:'https://www.nilkantho.in/feed', extra:{'stream':STREAM.FIRST_PAGE, 'lang':LANG.IN_BENGALI,'categories':CATEGORIES.NEWS}, type:RSS_TYPE.WORD_PRESS},
    ...
    {url:'https://gnebangla.in/category/sports-news/feed', extra:{'stream':STREAM.SPORTS, 'lang':LANG.IN_BENGALI,'categories':CATEGORIES.NEWS}, type:RSS_TYPE.WORD_PRESS},
    {url:'https://gnebangla.in/category/entertainment/feed', extra:{'stream':STREAM.ENTERTAINMENT, 'lang':LANG.IN_BENGALI,'categories':CATEGORIES.NEWS}, type:RSS_TYPE.WORD_PRESS},
    {url:'https://gnebangla.in/category/viral-news/feed', extra:{'stream':STREAM.VIRAL, 'lang':LANG.IN_BENGALI,'categories':CATEGORIES.NEWS}, type:RSS_TYPE.WORD_PRESS},
    {url:'https://gnebangla.in/category/lifestyle-news/feed', extra:{'stream':STREAM.LIFESTYLE, 'lang':LANG.IN_BENGALI,'categories':CATEGORIES.NEWS}, type:RSS_TYPE.WORD_PRESS},
    {url:'https://gnebangla.in/feed', extra:{'stream':STREAM.OTHER, 'lang':LANG.IN_BENGALI,'categories':CATEGORIES.NEWS}, type:RSS_TYPE.WORD_PRESS},
    ...
    {url:'https://kolkatatimes24.com/category/world/feed', extra:{'stream':STREAM.INTERNATIONAL, 'lang':LANG.IN_BENGALI,'categories':CATEGORIES.NEWS}, type:RSS_TYPE.WORD_PRESS},
    {url:'https://kolkatatimes24.com/category/sports/feed', extra:{'stream':STREAM.SPORTS, 'lang':LANG.IN_BENGALI,'categories':CATEGORIES.NEWS}, type:RSS_TYPE.WORD_PRESS},
    {url:'https://kolkatatimes24.com/category/offbeat/feed', extra:{'stream':STREAM.OFF_BEAT, 'lang':LANG.IN_BENGALI,'categories':CATEGORIES.NEWS}, type:RSS_TYPE.WORD_PRESS},
    {url:'https://kolkatatimes24.com/category/offbeat/fedd', extra:{'stream':STREAM.OFF_BEAT, 'lang':LANG.IN_BENGALI,'categories':CATEGORIES.NEWS}, type:RSS_TYPE.WORD_PRESS},
    {url:'https://kolkatatimes24.com/category/lifestyle/feed', extra:{'stream':STREAM.LIFESTYLE, 'lang':LANG.IN_BENGALI,'categories':CATEGORIES.NEWS}, type:RSS_TYPE.WORD_PRESS},
    {url:'https://kolkatatimes24.com/feed/', extra:{'stream':STREAM.FIRST_PAGE, 'lang':LANG.IN_BENGALI,'categories':CATEGORIES.NEWS}, type:RSS_TYPE.WORD_PRESS},

    // Bharat barta
    {url:'https://www.bharatbarta.com/category/entertainment/feed/', extra:{'stream':STREAM.ENTERTAINMENT, 'lang':LANG.IN_BENGALI,'categories':CATEGORIES.NEWS}, type:RSS_TYPE.WORD_PRESS},
    {url:'https://www.bharatbarta.com/category/news/international/feed', extra:{'stream':STREAM.INTERNATIONAL, 'lang':LANG.IN_BENGALI,'categories':CATEGORIES.NEWS}, type:RSS_TYPE.WORD_PRESS},
    ...
    {url:'https://www.bharatbarta.com/category/vairal/feed', extra:{'stream':STREAM.VIRAL, 'lang':LANG.IN_BENGALI,'categories':CATEGORIES.NEWS}, type:RSS_TYPE.WORD_PRESS},
    {url:'https://www.bharatbarta.com/category/bb-special/feed', extra:{'stream':STREAM.OFF_BEAT, 'lang':LANG.IN_BENGALI,'categories':CATEGORIES.NEWS}, type:RSS_TYPE.WORD_PRESS},
    {url:'https://www.bharatbarta.com/feed/', extra:{'stream':STREAM.LATEST, 'lang':LANG.IN_BENGALI,'categories':CATEGORIES.NEWS}, type:RSS_TYPE.WORD_PRESS},
    ...
    {url:'https://www.banglarpran.com/archives/category/entertrainment/feed', type:RSS_TYPE.WORD_PRESS, extra:{'lang':LANG.IN_BENGALI, 'stream':STREAM.ENTERTAINMENT}},
    {url:'https://www.banglarpran.com/archives/category/lifestyle/feed', type:RSS_TYPE.WORD_PRESS, extra:{'lang':LANG.IN_BENGALI, 'stream':STREAM.LIFESTYLE}},
    {url:'https://www.banglarpran.com/feed', type:RSS_TYPE.WORD_PRESS, extra:{'lang':LANG.IN_BENGALI, 'stream':STREAM.OTHER}},

   
    // youtube feed.
    {url:'https://www.youtube.com/feeds/videos.xml?channel_id=UCFaQMPEjeQZk7kcHX2RouBA', type:RSS_TYPE.YOUTUBE, extra:{ 'stream':STREAM.TECHNOLOGY,'lang':LANG.IN_BENGALI,'categories':CATEGORIES.VIDEO}},
    {url:'https://www.youtube.com/feeds/videos.xml?channel_id=UCxiudYA69dNRFEDgvolDbtA', type:RSS_TYPE.YOUTUBE, extra:{ 'stream':STREAM.TECHNOLOGY,'lang':LANG.IN_BENGALI,'categories':CATEGORIES.VIDEO}},
    {url:'https://www.youtube.com/feeds/videos.xml?channel_id=UC9YivGoN6UKWkl0k-8G1qyQ', type:RSS_TYPE.YOUTUBE, extra:{ 'stream':STREAM.TECHNOLOGY,'lang':LANG.IN_BENGALI,'categories':CATEGORIES.VIDEO}},
    {url:'https://www.youtube.com/feeds/videos.xml?channel_id=UCe_VQEe28mNPEwkBJ_kpxCg', type:RSS_TYPE.YOUTUBE, extra:{ 'stream':STREAM.EDUCATION,'lang':LANG.IN_BENGALI,'categories':CATEGORIES.VIDEO}},
    {url:'https://www.youtube.com/feeds/videos.xml?channel_id=UCjjyoWPQXhskdLLmv-RyzEQ', type:RSS_TYPE.YOUTUBE, extra:{ 'stream':STREAM.AUDIO_STORY,'lang':LANG.IN_BENGALI,'categories':CATEGORIES.VIDEO}},
