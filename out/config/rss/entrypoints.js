...
exports.urlList = [
    ...
    { url: 'https://www.banglarpran.com/archives/category/politics/feed', type: rss_reader_1.RSS_TYPE.WORD_PRESS, extra: { 'lang': CONST_1.LANG.BENGALI, 'stream': CONST_1.STREAM.POLITICS } },
    { url: 'https://www.banglarpran.com/archives/category/india/feed', type: rss_reader_1.RSS_TYPE.WORD_PRESS, extra: { 'lang': CONST_1.LANG.BENGALI, 'stream': CONST_1.STREAM.COUNTRY } },
    { url: 'https://www.banglarpran.com/archives/category/internation/feed', type: rss_reader_1.RSS_TYPE.WORD_PRESS, extra: { 'lang': CONST_1.LANG.BENGALI, 'stream': CONST_1.STREAM.INTERNATIONAL } },
    { url: 'https://www.banglarpran.com/archives/category/entertrainment/feed', type: rss_reader_1.RSS_TYPE.WORD_PRESS, extra: { 'lang': CONST_1.LANG.BENGALI, 'stream': CONST_1.STREAM.ENTERTAINMENT } },
    { url: 'https://www.banglarpran.com/archives/category/lifestyle/feed', type: rss_reader_1.RSS_TYPE.WORD_PRESS, extra: { 'lang': CONST_1.LANG.BENGALI, 'stream': CONST_1.STREAM.LIFESTYLE } },
    { url: 'https://www.banglarpran.com/feed', type: rss_reader_1.RSS_TYPE.WORD_PRESS, extra: { 'lang': CONST_1.LANG.BENGALI, 'stream': CONST_1.STREAM.OTHER } },
];
function startCrawl() {
